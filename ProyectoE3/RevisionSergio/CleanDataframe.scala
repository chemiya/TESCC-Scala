object CleanDataframe {
  def cleanDataframe(census_df: DataFrame): DataFrame = {
    ...
    // Categorización atributo wage_per_hour
    ...
    // Categorización atributo capital_gains
    ...
    // Categorización atributo capital_losses
    ...
    // Categorización atributo dividends_from_stocks
    ...
    // Categorización atributo total_person_earnings
    ...
    // Categorización atributo num_persons_worked_for_employer
    ...
    // Categorización atributo weeks_worked_in_year
    ...
    // Categorización atributo own_business_or_self_employed
    ...
    // Categorización atributo veterans_benefits
    ...
    // Para la entrega 3, se han eliminado los atributos "migration_code_change_in_msa","migration_code_change_in_reg","migration_code_move_within_reg"

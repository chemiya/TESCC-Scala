object CleanDataframe {
    ...
    def cleanDataframe2(census_df: DataFrame): DataFrame = {
        val intervalosAge = Array(0, 18, 35, 50, 70, 100)
        val labelsAge = Array("0-18", "19-35", "36-50", "51-70", "71-100")
        ...
        // Iteración 1 de atributos (entrega 2 grupal).

        // val nuevoDataFrame = census_df_nuevo.select("class_of_worker","education","marital_status","major_industry_code","major_occupation_code","member_of_labor_union","race","sex","full_or_part_time_employment_status","hispanic_Origin","tax_filer_status","region_of_previous_residence","detailed_household_and_family_status","detailed_household_summary_in_house_instance_weight","migration_code_change_in_msa","migration_code_change_in_reg","migration_code_move_within_reg","live_in_this_house_one_year_ago","family_members_under_18","citizenship","age-converted","wage_per_hour-converted","capital_gains-converted","capital_losses-converted","dividends_from_stocks-converted","total_person_earnings-converted","num_persons_worked_for_employer-converted","weeks_worked_in_year-converted","veterans_benefits-converted","own_business_or_self_employed-converted","income")

        // Iteración 2 de atributos (Selección final para entrega 2 grupal).

        // Removidos para entrega 2, con el objetivo de disminuir error: ,"age-converted","capital_gains-converted","capital_losses-converted","dividends_from_stocks-converted","num_persons_worked_for_employer-converted","weeks_worked_in_year-converted"
        // val nuevoDataFrame = census_df_nuevo.select("age","class_of_worker","education","marital_status","major_industry_code","major_occupation_code","member_of_labor_union","race","sex","full_or_part_time_employment_status","hispanic_Origin","tax_filer_status","region_of_previous_residence","detailed_household_and_family_status","detailed_household_summary_in_house_instance_weight","migration_code_change_in_msa","migration_code_change_in_reg","migration_code_move_within_reg","live_in_this_house_one_year_ago","family_members_under_18","citizenship","wage_per_hour","total_person_earnings","income")

        // Iteración 3 de atributos (entregable 2 individual)

        // No se usaron los atributos binned, como se había planteado en la entrega 2 grupal, ya que se observa que el cambio en maxBins no afecta la tasa de error, ya que estos atributos "xyz-converted" dejaron de ser continuos.
        // Para el propósito del ejercicio se usan las variables continuas originales

        // val nuevoDataFrame = census_df_nuevo.select("class_of_worker","education","marital_status","major_industry_code","major_occupation_code","member_of_labor_union","race","sex","full_or_part_time_employment_status","hispanic_Origin","tax_filer_status","region_of_previous_residence","detailed_household_and_family_status","detailed_household_summary_in_house_instance_weight","migration_code_change_in_msa","migration_code_change_in_reg","migration_code_move_within_reg","live_in_this_house_one_year_ago","family_members_under_18","citizenship","age","wage_per_hour","capital_gains","capital_losses","dividends_from_stocks","total_person_earnings","num_persons_worked_for_employer","weeks_worked_in_year","veterans_benefits","own_business_or_self_employed","income")

        val nuevoDataFrame = census_df_nuevo.select("class_of_worker","education","marital_status","major_industry_code","major_occupation_code","member_of_labor_union","race","sex","full_or_part_time_employment_status","tax_filer_status","age","wage_per_hour","total_person_earnings","num_persons_worked_for_employer","weeks_worked_in_year","income")

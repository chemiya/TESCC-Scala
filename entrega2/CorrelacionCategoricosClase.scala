...
*  
*  Script para analizar la correlación de los atributos categóricos con la clase
*
...
// recorremos los atributos y creamos la tabla de contingencia
